...
* **[SuperFamiconv](https://github.com/Optiroc/SuperFamiconv) ⭐ 194 | 🐛 0 | 🌐 Rust | 📅 2026-09-25** (MIT) - tile/map converter with flexible palette/optimization options and mostly-complete WS/WSC support.
...
* [ELKS](https://github.com/ghaerr/elks) ⭐ 1,709 | 🐛 28 | 🌐 C | 📅 2026-09-20 (GPL-2.0 + others) - Embedded Linux Kernel Subset kernel/operating system.
