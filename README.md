...
A curated list of awesome WonderSwan/WonderSwan Color development resources and tools. Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 503,108 | 🐛 106 | 📅 2026-09-02 list.
...
* **[SuperFamiconv](https://github.com/Optiroc/SuperFamiconv) ⭐ 190 | 🐛 21 | 🌐 C++ | 📅 2026-09-04** (MIT) - tile/map converter with flexible palette/optimization options and mostly-complete WS/WSC support.
...
* [ELKS](https://github.com/ghaerr/elks) ⭐ 1,698 | 🐛 27 | 🌐 C | 📅 2026-08-13 (GPL-2.0 + others) - Embedded Linux Kernel Subset kernel/operating system.
